...
ax.scatter(resultado["0.3.p"],recaudacion([resultado["0.3.p"]],b_v)/resultado["0.3.p"],color = 'red')
...
ax.scatter(resultado["0.4.p"],recaudacion([resultado["0.4.p"]],b_v)/resultado["0.4.p"],color = 'red')
plt.xticks(np.arange(0, 1, step=0.20))
ax.legend()
# Se añade un grilla
plt.grid(color = '0.95')
