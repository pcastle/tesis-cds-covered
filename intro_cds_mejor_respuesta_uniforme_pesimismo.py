...
if __name__ == '__main__':
    for b2_v in b2_vec:
        ...
        # Se añade un grilla
        ax.grid(color = '0.95')
        plt.savefig(f'figuras/intro_cds_mejor_respuesta_uniforme_b_{b2_v}_pesimismo.eps',format='eps')
        ...
        with open(f'equilibrios_intro_cds_uniforme_b_{b2_v}_pesimismo.json', 'w') as f:
