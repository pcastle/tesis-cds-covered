...
fig, ax = plt.subplots()
ax.plot(p2s1,f2_vec1,'k' ,label = '$u_2(p_2,p_1^* = 0.838)$')
ax.plot(p2s2,f2_vec2,'k--' ,label = '$u_2(p_2,p_1^* = 0.803)$')
ax.plot(p2s3,f2_vec3,'k:' ,label = '$u_2(p_2,p_1^* = 0.715)$')
ax.plot(p2s4,f2_vec4,'k-.' ,label = '$u_2(p_2,p_1^* = 0.849)$')
